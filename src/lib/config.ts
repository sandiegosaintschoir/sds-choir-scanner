 ...
 */
export const CHECKOUT_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLSe5S4yge_s8ajTstJ6U17o9VUj3oFEpBHUadDFsN_GOi0QE2A/viewform?usp=pp_url&entry.313553357={ids}';

/**
 * Google Form URL for checkin process.
 * The {ids} placeholder will be replaced with comma-separated scanned item IDs.
 */
export const CHECKIN_FORM_URL = 'https://docs.google.com/forms/d/e/1FAIpQLScGCRxW3jehdjonoVMcIcKIhJL8HOR5-2yR5f_HsYCj7pYgnw/viewform?usp=pp_url&entry.591811361={ids}';
